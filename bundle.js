...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)("document").ready(function () {
	    (0, _jquery2.default)("#searchbox").keypress(function (e) {
	        if (e.keyCode === 13) search(this.value);
	    });

	    (0, _jquery2.default)("#searchbtn").click(function () {
	        search((0, _jquery2.default)("#searchbox").value);
	    });

	    (0, _jquery2.default)('#randombtn').click(function () {
	        openPage(randomUrl);
	    });
	});
	...
	function search(keyword) {
	    ...
	    _jquery2.default.getJSON(wikiApi + keyword, function (jsonp) {
	        for (var i = 0; i < jsonp[1].length; i++) {
	            var resTitle = '<h5 id="resTitle">' + jsonp[1][i] + '</h5>';
	            var summary = '<p class="wikisnip">' + jsonp[2][i] + '</p>';
	            urls.push(jsonp[3][i]);

	            (0, _jquery2.default)('#results').append('<div class="grid-flex-container panels" id="' + i + '">' + resTitle + '<br />' + summary + '</div>');
	            (0, _jquery2.default)("#" + i).on('click', function () {
	                openPage(urls[(0, _jquery2.default)(this).attr('id')]);
	            });
	        }
	    });
	}
	...
	var getArticle = function getArticle() {
	    _jquery2.default.getJSON(wikiApi, function (data) {
	        console.log(data);
	    });
	};
